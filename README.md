...
See [![full API](https://pkg.go.dev/badge/github.com/Pafias/systray.svg)](https://pkg.go.dev/github.com/Pafias/systray) as well as [CHANGELOG](https://github.com/Pafias/systray/tree/master/CHANGELOG.md).
...
```sh
git clone https://github.com/Pafias/systray
cd systray/example
